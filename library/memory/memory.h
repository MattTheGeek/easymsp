...
/* CHANGE LOG
 * 02/01/2014 Matthew Burmeister
 * 	Created file. Added fillMemory(), copyMemory(), and detectMemory()
 */
...
void fillMemory(unsigned short int, unsigned short int, unsigned short int);
void copyMemory(unsigned short int, unsigned short int, unsigned short int);
